...
def Lire( parametre ):
    ...
    question_pts = random.sample(range(4),2)
    tex_repere(exo, coord_pts, noms_pts)
    tex_repere(cor, coord_pts, noms_pts)
    exo.append(u"\\newline Des points %s et %s" % (noms_pts[question_pts[0]], noms_pts[question_pts[1]]))
    cor.append(u"\\newline %s %s et %s %s"% (noms_pts[question_pts[0]],tex_coord(coord_pts[question_pts[0]]),noms_pts[question_pts[1]],tex_coord(coord_pts[question_pts[1]])))
