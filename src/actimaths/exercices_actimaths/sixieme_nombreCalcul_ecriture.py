...
def EcritEnChiffreEntier(parametre):
    ...
    cor.append(u"%s s'écrit \\fbox{%s}" % (EcritNombreDecimal(lnb), Affichage.decimaux(lnb, 0)))
...
def EcritEnLettreEntier(parametre):
    ...
    cor.append(u"%s s'écrit \\fbox{\\begin{minipage}{0.8\\linewidth}" %Affichage.decimaux(lnb, 0))
